...
<body style="margin:0;padding:0;background:#1C1C1C;font-family:Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#1C1C1C;padding:40px 20px;">
    <tr><td align="center">
      <table width="520" cellpadding="0" cellspacing="0" style="background:#242424;border-radius:4px;border:1px solid rgba(255,255,255,0.08);max-width:100%;">
        <tr><td style="background:#E1A813;height:4px;"></td></tr>
        <tr><td style="padding:40px 40px 30px;">
          <div style="font-family:Arial,sans-serif;font-size:28px;font-weight:900;color:#F0F0F0;letter-spacing:-1px;margin-bottom:24px;">N<span style="color:#E1A813;">/</span>NPC</div>
          <p style="color:#F0F0F0;font-size:18px;font-weight:700;margin:0 0 12px;">${t.greeting(name)}</p>
          <p style="color:#D0D0D0;font-size:15px;line-height:1.7;margin:0 0 28px;">${t.body}</p>
          <table cellpadding="0" cellspacing="0" border="0" role="presentation" style="margin:0 0 24px;">
            <tr>
              <td align="center" bgcolor="#E1A813" style="background:#E1A813;border-radius:2px;">
                <a href="${safeLink}" target="_blank" style="color:#1C1C1C;display:inline-block;font-family:Arial,sans-serif;font-size:17px;font-weight:bold;line-height:20px;text-decoration:none;padding:16px 30px;border:1px solid #E1A813;border-radius:2px;">${escapeHTML(t.button)}</a>
              </td>
            </tr>
          </table>
          <p style="color:#D0D0D0;font-size:15px;margin:0 0 10px;line-height:1.7;">${t.copy}</p>
          <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="margin:0 0 24px;">
            <tr>
              <td style="background:#1C1C1C;border:1px solid rgba(225,168,19,0.36);padding:14px;font-family:Arial,sans-serif;font-size:15px;line-height:1.7;word-break:break-all;">
                <a href="${safeLink}" target="_blank" style="color:#E1A813;text-decoration:underline;font-weight:bold;">${safeLink}</a>
              </td>
            </tr>
          </table>
          <p style="color:#A8A8A8;font-size:13px;margin:0;line-height:1.6;">${t.note}</p>
        </td></tr>
        <tr><td style="padding:20px 40px;border-top:1px solid rgba(255,255,255,0.06);">
          <p style="color:#555;font-size:11px;margin:0;">© 2026 N/NPC Smart Manufacturing Solutions</p>
        </td></tr>
      </table>
    </td></tr>
  </table>

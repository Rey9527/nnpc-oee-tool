...
function airtableUrl(path, params) {
  ...
  const table = encodeURIComponent(requireEnv('AIRTABLE_TABLE_NAME'));
    ...
    <tr><td align="center">
      <table width="520" cellpadding="0" cellspacing="0" style="background:#242424;border-radius:4px;border:1px solid rgba(255,255,255,0.08);max-width:100%;">
        ...
        <tr><td style="padding:40px 40px 30px;">
          ...
          <a href="${link}" style="display:inline-block;background:#E1A813;color:#1C1C1C;font-weight:700;font-size:15px;letter-spacing:1px;text-transform:uppercase;text-decoration:none;padding:14px 32px;border-radius:2px;">${t.button}</a>
          <p style="color:#555;font-size:12px;margin:24px 0 0;line-height:1.6;">${t.note}<br>${t.copy} <span style="color:#E1A813;">${link}</span></p>
        </td></tr>

...
function verifyLinkFor(email) {
  ...
  return `${site}/oee?token=${encodeURIComponent(token)}`;
}
...
<body style="margin:0;padding:24px;font-family:Arial,sans-serif;color:#222222;background:#ffffff;">
  <p style="font-size:16px;line-height:1.6;margin:0 0 24px;">N/NPC</p>
  <p style="font-size:16px;line-height:1.6;margin:0 0 12px;">${t.greeting(name)}</p>
  <p style="font-size:16px;line-height:1.6;margin:0 0 20px;">${t.body}</p>
  <p style="font-size:18px;line-height:1.6;margin:0 0 20px;">
    <a href="${safeLink}" target="_blank" style="color:#0645AD;text-decoration:underline;font-weight:bold;">${escapeHTML(t.button)}</a>
  </p>
  <p style="font-size:14px;line-height:1.6;margin:0 0 20px;color:#555555;">${t.note}</p>
  <p style="font-size:12px;line-height:1.6;margin:0;color:#777777;">© 2026 N/NPC Smart Manufacturing Solutions</p>
</body></html>`;
}

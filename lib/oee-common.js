      ...
      <table width="520" cellpadding="0" cellspacing="0" style="background:#242424;border-radius:4px;border:1px solid rgba(255,255,255,0.08);max-width:100%;">
        ...
        <tr><td style="padding:40px 40px 30px;">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="margin:0 0 24px;">
            <tr>
              <td align="center" bgcolor="#E1A813" style="border-radius:2px;">
                <a href="${safeLink}" target="_blank" style="display:block;background:#E1A813;color:#1C1C1C;font-weight:900;font-size:18px;text-decoration:none;padding:18px 24px;border-radius:2px;">${t.button}</a>
              </td>
            </tr>
          </table>
          <p style="color:#D0D0D0;font-size:15px;margin:0 0 10px;line-height:1.7;">${t.copy}</p>
          <p style="font-size:16px;line-height:1.7;margin:0 0 24px;word-break:break-all;background:#1C1C1C;border:1px solid rgba(225,168,19,0.36);padding:14px;">
            <a href="${safeLink}" target="_blank" style="color:#E1A813;text-decoration:underline;font-weight:700;">${safeLink}</a>
          </p>

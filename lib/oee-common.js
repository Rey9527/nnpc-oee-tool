    ...
    <tr><td align="center">
      <table width="520" cellpadding="0" cellspacing="0" style="background:#242424;border-radius:4px;border:1px solid rgba(255,255,255,0.08);max-width:100%;">
        ...
        <tr><td style="padding:40px 40px 30px;">
          ...
          <p style="color:#888;font-size:14px;line-height:1.7;margin:0 0 28px;">${t.body}</p>
          <table cellpadding="0" cellspacing="0" role="presentation" style="margin:0 0 26px;">
            <tr>
              <td bgcolor="#E1A813" style="border-radius:2px;">
                <a href="${safeLink}" target="_blank" style="display:inline-block;background:#E1A813;color:#1C1C1C;font-weight:700;font-size:16px;letter-spacing:1px;text-transform:uppercase;text-decoration:none;padding:15px 34px;border-radius:2px;">${t.button}</a>
              </td>
            </tr>
          </table>
          <p style="color:#A8A8A8;font-size:14px;margin:0 0 10px;line-height:1.7;">${t.copy}</p>
          <p style="font-size:14px;line-height:1.7;margin:0 0 24px;word-break:break-all;">
            <a href="${safeLink}" target="_blank" style="color:#E1A813;text-decoration:underline;">${safeLink}</a>
          </p>
          <p style="color:#777;font-size:12px;margin:0;line-height:1.6;">${t.note}</p>
        </td></tr>

...
const SHARED = {
  zh: {
    ...
    solution4Sub: 'RTLS、LoRaWAN、BLE/BLT 與即時追蹤',
  ...
  en: {
    ...
    solution4Sub: 'RTLS, LoRaWAN, BLE/BLT, and real-time tracking',
  ...
  th: {
    ...
    solution4: 'RTLS & Connectivity',
    solution4Sub: 'RTLS, LoRaWAN, BLE/BLT และการติดตามแบบเรียลไทม์',
